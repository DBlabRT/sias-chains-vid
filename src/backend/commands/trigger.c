...
ExecARDeleteTriggers(EState *estate, ResultRelInfo *relinfo,
					 ItemPointer tupleid, ItemPointer entryPoint)
{
	TriggerDesc *trigdesc = relinfo->ri_TrigDesc;
...
ExecARUpdateTriggers(EState *estate, ResultRelInfo *relinfo,
					 ItemPointer tupleid, ItemPointer entryPoint,
					 ItemPointer newtupleid, List *recheckIndexes)
{
	TriggerDesc *trigdesc = relinfo->ri_TrigDesc;
	...
	if (trigdesc && trigdesc->n_after_row[TRIGGER_EVENT_UPDATE] > 0)
	{
		HeapTuple trigtuple = GetTupleForTrigger(estate, NULL, relinfo,
												   tupleid, entryPoint, NULL);
		HeapTuple newtuple = GetTupleForTrigger(estate, NULL, relinfo,
													  newtupleid, entryPoint, NULL);
...
ltrmark:;
		...
		switch (test)
		{
			...
			case HeapTupleUpdated:
				...
				/*
				 * if PlanQual failed for updated tuple -
