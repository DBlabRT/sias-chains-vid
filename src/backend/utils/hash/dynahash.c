...
/*
 * allows other modules to get HTAB's size
 * without making HTAB visible to them
 */
Size
sizeOfHTAB(void)
{
...
/*
 * allows other modules to get HASHHDR's size
 * without making HASHHDR visible to them
 */
Size
sizeOfHASHHDR(void)
{
	return sizeof(HASHHDR);
}
