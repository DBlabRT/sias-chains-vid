...
btinsert(PG_FUNCTION_ARGS)
{
	...
	ItemVid	   *ht_vid = (ItemVid*) PG_GETARG_POINTER(4);
	Relation	heapRel = (Relation) PG_GETARG_POINTER(5);
	IndexUniqueCheck checkUnique = (IndexUniqueCheck) PG_GETARG_INT32(6);
	bool		result;
	IndexTuple	itup;
