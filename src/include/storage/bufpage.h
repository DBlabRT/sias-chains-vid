...
#define PD_ALL_VISIBLE		0x0004		/* all tuples on page are visible to
										 * everyone */
#define PD_SIAS_HOT			0x0008		/* Does the page hold hot data? */
#define PD_SIAS_INPLACE		0x0010		/* Has there been an inplace update? */
...
#define PageIsSiasHot(page) \
	(((PageHeader) (page))->pd_flags & PD_SIAS_HOT)
#define PageSetSiasHot(page) \
	(((PageHeader) (page))->pd_flags |= PD_SIAS_HOT)

#define PageIsSiasInplace(page) \
	(((PageHeader) (page))->pd_flags & PD_SIAS_INPLACE)
#define PageSetSiasInplace(page) \
	(((PageHeader) (page))->pd_flags |= PD_SIAS_INPLACE)
#define PageClearSiasInplace(page) \
	(((PageHeader) (page))->pd_flags &= ~PD_SIAS_INPLACE)
...
extern bool PageDeleteLastItem(Page page);
extern void PageAddVidTidPair(Page page, Item item, OffsetNumber offsetNumber);
