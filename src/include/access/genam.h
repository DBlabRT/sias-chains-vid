...
extern HeapTuple index_getnext_postgres(IndexScanDesc scan, ScanDirection direction);
extern HeapTuple index_getnext_sias(IndexScanDesc scan, ScanDirection direction);
