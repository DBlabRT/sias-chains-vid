...
extern TupleTableSlot *EvalPlanQual(EState *estate, EPQState *epqstate,
			 ...
			 ItemPointer tid, ItemPointer entryPoint, TransactionId priorXmax);
extern TupleTableSlot *EvalPlanQualPostgres(EState *estate, EPQState *epqstate,
			 Relation relation, Index rti,
			 ItemPointer tid, TransactionId priorXmax);
extern TupleTableSlot *EvalPlanQualSias(EState *estate, EPQState *epqstate,
			 Relation relation, Index rti,
			 ItemPointer tid, ItemPointer entryPoint, TransactionId priorXmax);
extern HeapTuple EvalPlanQualFetch(EState *estate, Relation relation,
				  int lockmode, ItemPointer tid, ItemPointer entryPoint,
				  TransactionId priorXmax);
extern HeapTuple EvalPlanQualFetchPostgres(EState *estate, Relation relation,
				  int lockmode, ItemPointer tid, TransactionId priorXmax);
extern HeapTuple EvalPlanQualFetchSias(EState *estate, Relation relation,
				  int lockmode, ItemPointer tid, ItemPointer entryPoint,
				  TransactionId priorXmax);
...
extern List *ExecInsertIndexTuples(TupleTableSlot *slot, ItemPointer tupleid, ItemVid *tupleVid,
					  EState *estate);
