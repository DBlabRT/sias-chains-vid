...
/* support for bucket buffer refcount management */
extern void ResourceOwnerEnlargeBucketBuffers(ResourceOwner owner);
extern void ResourceOwnerRememberBucketBuffer(ResourceOwner owner, VidMappingInfo *vmi, Buffer buffer);
extern void ResourceOwnerForgetBucketBuffer(ResourceOwner owner, VidMappingInfo *vmi, Buffer buffer);
