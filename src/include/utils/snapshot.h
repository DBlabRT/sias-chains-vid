 ...
 * function.
 */
typedef bool (*SnapshotSatisfiesFunc) (Relation rel, HeapTuple tuple, Snapshot snapshot, Buffer buffer, bool* isXminValid);
...
typedef enum
{
	...
	HeapTupleSiasUpdated,
	HeapTupleSiasDeleted
} HTSU_Result;
