...
typedef struct RelationData
{
	...
	VidMappingInfo *rd_vmi;			/* pointer to relation's VidMappingInfo in shmem */
	TargetBlockInfo *rd_tbi;		/* pointer to relation's TargetBlockInfo in shmem */
	GarbageCollectionInfo *rd_gci;	/* pointer to relation's GarbageCollectionInfo in shmem */
...
/*
 * RelationGetHighestTargetBlockSias
 *		Fetch relation's highest BlockNumber'ed target block.
 */
#define RelationGetHighestTargetBlockSias(relation) \
	((relation)->rd_tbi->firstOverflowBlock + SIAS_OVERFLOW_TARGET_BLOCKS - 1)
